...
class MqttClient {
    ...
    handleStateAttributes() {
        this.robot.state.attributes.forEach(attribute => {
            ...
            if (attribute instanceof attributes.LatestCleanupStatisticsAttribute) {
                handlerId = "LatestCleanupStatisticsAttribute" + "." + attribute.type;
                handlerConstructor = attributeHandlers.state.LatestCleanupStatisticsAttributeMqttHandler;
            }
